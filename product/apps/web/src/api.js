...
export const api = {
  ...
  getServiceEnvBundle: (projectId, serviceId) =>
    request(`/api/projects/${projectId}/services/${serviceId}/env-bundle`),
  upsertServiceEnvBundle: (projectId, serviceId, payload) =>
    request(`/api/projects/${projectId}/services/${serviceId}/env-bundle`, {
      method: "POST",
      body: payload instanceof FormData ? payload : JSON.stringify(payload),
    }),
  deleteServiceEnvBundle: (projectId, serviceId) =>
    request(`/api/projects/${projectId}/services/${serviceId}/env-bundle`, {
      method: "DELETE",
    }),
